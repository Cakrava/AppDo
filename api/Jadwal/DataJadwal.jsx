  ...
  const renderItemJadwal = ({item}) => {
    const bukadetail = () => {
      navigation.navigate('DetailJadwal', {
        kodejadwal_2020023: item.kodejadwal_2020023,
        foto: item.foto,
      });
    };
    ...
    return (
      <TouchableOpacity style={styles.item}>
        <View style={styles.container}>
          <Text style={styles.item}>Dosen: {item.nama_dosen_2020023}</Text>
          <Text style={styles.item}>Kode: {item.kodejadwal_2020023}</Text>
          <Text style={styles.item}>
            Waktu: {item.hari_2020023} | {item.jammulai_2020023} -{' '}
            {item.jamakhir_2020023}
          </Text>
          <Text style={styles.item}>Ruang: {item.ruangan_2020023}</Text>
          <Text style={styles.item}>
            Matakuliah: {item.nama_matakuliah_2020023}
          </Text>
        </View>
      </TouchableOpacity>
    );
  ...
  return (
    <View style={styles.Dinding}>
      ...
      <FlatList
        ...
        keyExtractor={item => item.kodejadwal_2020023}
