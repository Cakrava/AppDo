...
export default function FormEdit({route}) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        const response = await fetch(`${apiUrl}mahasiswa/${nim}`, {
          headers: {
        ...
        setJenisKelamin(json.jenis_kelamin_2020023);
        setTempatLahir(json.tmp_lahir_2020023);
        setTanggalLahir(new Date(json.tgl_lahir_2020023));
  ...
  const submitForm = async () => {
    ...
    const formData = {
      ...
      jenis_kelamin_2020023: jenisKelamin,
      tmp_lahir_2020023: tempatLahir,
      tgl_lahir_2020023: tanggalLahir.toISOString().split('T')[0],
      alamat_2020023: alamat,
      notelp_2020023: noTelp,
      _method: 'PUT',
    };

    fetch(`${apiUrl}mahasiswa/${nim}`, {
      method: 'POST',
      headers: {
        ...
        Alert.alert('Success', 'Data mahasiswa berhasil di Update', [
          {
            text: 'ok',
            onPress: () =>
              navigation.navigate('DetailMahasiswa', {nim_2020023: nim}),
          },
        ]);
      })
      .catch(error => {
  ...
  return (
    <ScrollView
      ...
      <Input
        ...
        leftIcon={<Icon name="user-circle" size={24} color="#FF00ff" />}
        errorMessage={validationErrors.nim_2020023}
      />
      ...
      <Input
        ...
        inputContainerStyle={styles.inputContainer}
        inputStyle={styles.inputText}
        leftIcon={<Icon name="user" size={24} color="#FF00ff" />}
      ...
      <Input
        ...
        leftIcon={<Icon name="home" size={24} color="#FF00ff" />}
        placeholderTextColor="#ccc"
        inputContainerStyle={styles.inputContainer}
        inputStyle={styles.inputText}
        errorMessage={validationErrors.tmp_lahir_2020023}
      />
      ...
      <Input
        ...
        leftIcon={<Icon name="map-marker-alt" size={24} color="#FF00ff" />}
        placeholderTextColor="#ccc"
        inputContainerStyle={styles.inputContainer}
        inputStyle={styles.inputText}
      ...
      <Input
        ...
        leftIcon={<Icon name="phone" size={24} color="#FF00ff" />}
        placeholderTextColor="#ccc"
        inputContainerStyle={styles.inputContainer}
        inputStyle={styles.inputText}
