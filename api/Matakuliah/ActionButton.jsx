...
const ActionButton = ({kode}) => {
  ...
  const actionDeleteData = async () => {
    ...
    Alert.alert(
      'Konfirmasi',
      'Apakah ang yakin ma apuih data matakuliah ko?',
      [
        {
          text: 'Batal',
            ...
            fetch(`${apiUrl}matakuliah/${kode}`, {
              ...
              .then(response => {
                if (response.status === 200) {
                  Alert.alert('', 'Data matakuliah alah tahapuih!!!', [
                    {
                      text: 'Ok',
                      onPress: () =>
                        navigation.navigate('DataMatakuliah', {
                          dataAdded: true,
                        }),
                    },
                  ]);
  ...
  const showFormEdit = () => {
    navigation.navigate('FormEdit', {kode: kode});
  };
